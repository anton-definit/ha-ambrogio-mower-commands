"""Human-readable mappings for Ambrogio/ZCS mower data."""

from __future__ import annotations

# Model codes → Model names
ROBOT_MODELS = {
    "AM015D": "L15 Deluxe",
...
# Index-based state descriptors
ROBOT_STATES = [
    {"name": "unknown", "icon": "mdi:crosshairs-question", "color": "#000000"},
    {"name": "charge", "icon": "mdi:battery-charging", "color": "#CCCC00"},
    {"name": "work", "icon": "mdi:state-machine", "color": "#007700"},
    {"name": "pause", "icon": "mdi:pause", "color": "#0000FF"},
    {"name": "fail", "icon": "mdi:alert-circle", "color": "#FF0000"},
    {"name": "nosignal", "icon": "mdi:signal-off", "color": "#FF7700"},
    {"name": "gotostation", "icon": "mdi:ev-station", "color": "#FFFF00"},
    {"name": "gotoarea", "icon": "mdi:grass", "color": "#00FF00"},
    {"name": "bordercut", "icon": "mdi:scissors-cutting", "color": "#00CC00"},
    {"name": "expired", "icon": "mdi:clock-alert", "color": "#000000"},
    {"name": "renewed", "icon": "mdi:clock-check", "color": "#00B5B5"},
    {"name": "work_standby", "icon": "mdi:power-standby", "color": "#E61EDC"},
    {"name": "hot_temperature", "icon": "mdi:thermometer-alert", "color": "#DB4B4B"},
    {"name": "mapping_started", "icon": "mdi:map-marker-star", "color": "#007A08"},
    {"name": "mapping_ended", "icon": "mdi:map-marker-check", "color": "#D67070"},
]
...
DATA_THRESHOLD_STATES = [
    {"name": "less_then_50_percent", "color": "#0AFA2A"},
    {"name": "50_percent", "color": "#DCFC0F"},
    {"name": "75_percent", "color": "#FA7E0A"},
    {"name": "100_percent", "color": "#FA0D0D"},
]

ATOMIZER_STATES = [
    {"name": "unknown", "color": "#000000"},
    {"name": "empty", "color": "#CCCC00"},
    {"name": "work", "color": "#007700"},
    {"name": "pause", "color": "#0000FF"},
    {"name": "fail", "color": "#FF0000"},
]

INFINITY_PLAN_STATES = [
    {"name": "unknown", "color": "#000000"},
    {"name": "active", "color": "#2BB800"},
    {"name": "expired", "color": "#F50000"},
    {"name": "deactivated", "color": "#C208F0"},
    {"name": "pending", "color": "#FFE100"},
]
